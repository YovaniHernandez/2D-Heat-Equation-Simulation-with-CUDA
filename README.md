...
CUDA Acceleration: Parallel implementation using a 5-point stencil.Shared Memory Optimization: Uses GPU shared memory and halo cells to minimize global memory latency.Double Buffering: Prevents race conditions during temporal iterations.
...
Metric        Sequential(CPU)       CUDA (GPU)
